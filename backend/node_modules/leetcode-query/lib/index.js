"use strict";var j=Object.create;var S=Object.defineProperty;var V=Object.getOwnPropertyDescriptor;var H=Object.getOwnPropertyNames;var J=Object.getPrototypeOf,W=Object.prototype.hasOwnProperty;var Y=(n,t)=>{for(var e in t)S(n,e,{get:t[e],enumerable:!0})},q=(n,t,e,i)=>{if(t&&typeof t=="object"||typeof t=="function")for(let s of H(t))!W.call(n,s)&&s!==e&&S(n,s,{get:()=>t[s],enumerable:!(i=V(t,s))||i.enumerable});return n};var g=(n,t,e)=>(e=n!=null?j(J(n)):{},q(t||!n||!n.__esModule?S(e,"default",{value:n,enumerable:!0}):e,n)),K=n=>q(S({},"__esModule",{value:!0}),n);var ie={};Y(ie,{BASE_URL:()=>d,BASE_URL_CN:()=>f,Cache:()=>v,Credential:()=>y,LeetCode:()=>_,LeetCodeCN:()=>G,Mutex:()=>k,RateLimiter:()=>b,USER_AGENT:()=>c,cache:()=>h,caches:()=>X,default:()=>te});module.exports=K(ie);var M=g(require("events")),P=g(require("node-fetch"));var v=class{constructor(){this._table={}}get(t){let e=this._table[t];if(e){if(e.expires>Date.now())return e.value;this.remove(t)}return null}set(t,e,i=6e4){this._table[t]={key:t,value:e,expires:i>0?Date.now()+i:0}}remove(t){delete this._table[t]}clear(){this._table={}}load(t){this._table=JSON.parse(t)}},h=new v,X={default:h};var d="https://leetcode.com",f="https://leetcode.cn",c="Mozilla/5.0 LeetCode API";var I=g(require("node-fetch"));function p(n){return n.split(";").map(t=>t.trim().split("=")).reduce((t,e)=>(t[e[0]]=e[1],t),{})}async function Z(){let n=await(0,I.default)(d,{headers:{"user-agent":c}}).then(e=>e.headers.get("set-cookie"));return p(n).csrftoken}var y=class{constructor(t){t&&(this.session=t.session,this.csrf=t.csrf)}async init(t){return this.csrf=await Z(),t&&(this.session=t),this}};var U=`
