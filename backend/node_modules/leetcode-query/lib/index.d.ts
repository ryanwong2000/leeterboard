...
declare type ProblemDifficulty = "Easy" | "Medium" | "Hard";
interface Problem {
    questionId: string;
...
declare type SubmissionStatus = "Accepted" | "Wrong Answer" | "Time Limit Exceeded" | "Memory Limit Exceeded" | "Output Limit Exceeded" | "Compile Error" | "Runtime Error";
...
declare type Release = (value: void | PromiseLike<void>) => void;
...
export { AcSubmissionNum, AllQuestionsCount, BASE_URL, BASE_URL_CN, Badge, Cache, CacheItem, CacheTable, ChallengeQuestion, CodeSnippet, Contest, ContestInfo, ContestRanking, Contributions, Credential$1 as Credential, DailyChallenge, ICredential, LeetCode, LeetCodeCN, LeetCodeGraphQLQuery, LeetCodeGraphQLResponse, MatchedUser, Mutex, OfficialSolution, Problem, ProblemDifficulty, ProblemList, Profile$1 as Profile, RateLimiter, RecentSubmission, Release, Submission, SubmissionDetail, SubmissionStatus, SubmitStats, TopicTag, TotalSubmissionNum, USER_AGENT, UserContestInfo, UserProfile, Whoami, cache, caches, LeetCode as default };
